...
Fork this repository: https://github.com/rolling-scopes-school/human-readable-number/

Clone your newly created repo: https://github.com/<%your_github_username%>/human-readable-number/

Go to folder human-readable-number
...
Save the solution and run npm test in command line.
...
Select your task (Human Readable Number)
